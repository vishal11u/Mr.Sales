  ...
  return (
    <div className="max-w-4xl mx-auto py-16 px-4 text-center animate-fade-in">
      ...
      <p className="mt-6 text-lg leading-8 text-content-200 dark:text-dark-content-200">
        We appreciate your interest in Sales Coach AI. If you have any questions, feedback, or inquiries, please feel
      ...
      <div className="mt-12">
        ...
        <a 
            href="mailto:support@salescoachai.example.com"
        ...
        >
            support@salescoachai.example.com
        </a>
